...
public class KinectGestures
{
    ...
    public interface GestureListenerInterface
    {
        ...
        void GestureInProgress(uint userId, int userIndex, Gestures gesture, float progress,
            Kinect.NuiSkeletonPositionIndex joint, Vector3 screenPos);
        ...
        bool GestureCancelled(uint userId, int userIndex, Gestures gesture,
            Kinect.NuiSkeletonPositionIndex joint);
    }
    ...
    private const int leftHandIndex =  (int)Kinect.NuiSkeletonPositionIndex.HandLeft;
    private const int rightHandIndex = (int)Kinect.NuiSkeletonPositionIndex.HandRight;

    private const int leftElbowIndex = (int)Kinect.NuiSkeletonPositionIndex.ElbowLeft;
    private const int rightElbowIndex = (int)Kinect.NuiSkeletonPositionIndex.ElbowRight;

    private const int leftShoulderIndex = (int)Kinect.NuiSkeletonPositionIndex.ShoulderLeft;
    private const int rightShoulderIndex = (int)Kinect.NuiSkeletonPositionIndex.ShoulderRight;

    private const int hipCenterIndex = (int)Kinect.NuiSkeletonPositionIndex.HipCenter;
    private const int shoulderCenterIndex = (int)Kinect.NuiSkeletonPositionIndex.ShoulderCenter;
    private const int leftHipIndex = (int)Kinect.NuiSkeletonPositionIndex.HipLeft;
    private const int rightHipIndex = (int)Kinect.NuiSkeletonPositionIndex.HipRight;
